...
<?php if ($content): ?>
  <footer id="footer" class="<?php print $classes; ?>">
    <div id="footer-first-line" class="footer footer-line"><?php print t("&copy; ");print date("Y");print t(" EU-OSHA | ");global $language;print l(t("an agency of the European Union"),"http://europa.eu/index_".$language->language.".htm"); ?></div>
